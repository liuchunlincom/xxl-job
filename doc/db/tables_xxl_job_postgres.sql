...
SELECT setval('xxl_job_info_id_seq', 2, true);
...
SELECT setval('xxl_job_log_id_seq', 2, true);
...
SELECT setval('xxl_job_logglue_id_seq', 2, true);
...
SELECT setval('xxl_job_log_report_id_seq', 2, true);
...
SELECT setval('xxl_job_registry_id_seq', 2, true);
